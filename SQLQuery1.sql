use sales;-- create data base
GO
create schema production; -- create schema
GO
create table production.customers --create table
(
customer_id int not null, -- create column : column_name type_column allow to be null or not
...
constraint customers_pk primary key (customer_id) -- use constraint to call for primary key
);
...
alter table store -- to add modification to existence table
